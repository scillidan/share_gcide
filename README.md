...
The data of `gcide-w108121` is from `gcide.zip` (StarDict) on [Free StarDict dictionaries](https://tuxor1337.frama.io/firedict/dictionaries.html) ([0.48](https://dict.org/bin/Dict?Form=Dict3&Database=gcide)?). Only one obvious style repair was made.
